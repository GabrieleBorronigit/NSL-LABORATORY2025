...
public:
  GA(int N_chromosomes, int N_genes, int rank);
  ...
  void Replace(const int best[], const mat &D, int place=0); //replaces the worst chromosome with the best from another continent
protected:
