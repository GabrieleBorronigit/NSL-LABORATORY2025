...
public:
  ...
  //inverse cumulative method to generate a random number with exponential distribution
  double Exp(double lambda=1.0);
    //inverse cumulative method to generate a random number with Lorentzian distribution
  double Lorentz(double mu=0.0, double gamma=1.0);
};
